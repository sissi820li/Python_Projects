...
start = time.time()
counter = bubble_sort(list_of_numbers2)
end = time.time()
final_time = end - start
print('**timer for bubble_sort(): ' + '%.3f' % (final_time) + 's**')
print('**counter for bubble_sort(): ' + str(counter))

if list_of_numbers2 == sorted_list:
    print('Bubble sort list has been sorted correctly.')
